...
// Parameters:
// 	expr	(ionput expring)		expression to examine
...
// currentToken
// Identifies the current non-space character in the given expring
// Parameters:
...
// Post-condition:   expr[pos] is not a space
// NOTE:  expr[pos] may be the null character at the end of the expring
